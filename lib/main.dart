...
import 'package:messaging_testing/logs.dart';
import 'package:messaging_testing/message.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void _createClient() async {
    _client =
        await AgoraRtmClient.createInstance('ebe9bdb437fb47a09a47d52f3c73ecbf');
